...
class MainThread(Thread):
    ...
    def run(self):
        ...
        for w in weather:
            ...
            data_dict['cloud_type'].append(w[0]['description'])
        # print(data_dict)
...
class Main(QMainWindow):
    ...
    def draw(self):
        ...
        print(data_dict)
        # print(new_df)
        # print(new_df["cloud_type"])
        sns.set_theme(style="darkgrid")
        plt.figure(figsize=(25, 10), )
        # plot = sns.lineplot(x="type", y="dt_txt", hue='cloud',
        #                     data=new_df)
        # plt.setp(plot.get_xticklabels(), rotation=10)
        self.ui.graphicsView.plot(kind="scatter", x=data_dict["temp"], y=data_dict["feels_like"])
